...
execute as @p run item modify entity @p weapon.mainhand [{"function":"minecraft:set_item","item":"minecraft:iron_hoe"},{"function":"minecraft:set_components","components":{"minecraft:item_model":"vpax:iron_paxel_h"}}]
title @p actionbar ["",{"text":"Plow Mode < ","color":"green"},{"text":" Path Mode","color":"red"}]

playsound minecraft:item.armor.equip_iron player @s ~ ~ ~ 0.2 1.7
